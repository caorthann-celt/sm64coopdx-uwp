...
LIBAPI int   uwp_GetXboxHdmiDisplaySize(int* x, int* y); // Gets the Xbox HDMI raw pixel size, returns 1 if available
...
LIBAPI void* uwp_GetActualCoreWindowReference(); // No cache, explicit CoreWindow name
LIBAPI void* uwp_GetCoreWindowReference(); // Cached, explicit CoreWindow name
